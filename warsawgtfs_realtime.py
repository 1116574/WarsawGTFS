...
if __name__ == "__main__":
    ...
    argprs.add_argument("--gtfs-file", default="https://mkuran.pl/gtfs/warsaw.zip", required=False, dest="gtfs_path", help="path/URL to the GTFS file")
    argprs.add_argument("--brigades-file", default="https://mkuran.pl/gtfs/warsaw/brigades.json", required=False, dest="brigades_path", help="path/URL to brigades JSON file (created by option -b)")
